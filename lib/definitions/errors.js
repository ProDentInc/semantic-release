...
See the [workflow configuration documentation](${linkify('docs/usage/workflow-configuration.md')}) for more details.`,
  ...
  EMODIFIERPATH: ({type}) => ({
    message: `The modifier could not be loaded. The path is of the wrong type.`,
    details: `The modifier path must be a string, "${type}" given.`,
  }),
  EMODIFIERTYPE: ({type}) => ({
    message: `The modifier could not be loaded. The modifier is of the wrong type.`,
    details: `The modifier must be a function or an object, "${type}" given.`,
  }),
  EMODIFIERNONAME: ({type}) => ({
    message: `Invalid modifier. Modifier must contain a name`,
    details: `The modifier is missing the "name" property or the property "name" is of the wrong type, "${type}" given.`,
  }),
  EMODIFIERNOREQUIRED: ({name, type}) => ({
    message: `Invalid modifier. Modifier must contain the function "${name}"`,
    details: `The modifier is missing the "${name}" function or the property "${name}" is of the wrong type, "${type}" given.`,
  }),
};
