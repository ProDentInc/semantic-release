...
See the [workflow configuration documentation](${linkify('docs/usage/workflow-configuration.md')}) for more details.`,
  ...
  EMODIFIERPATH: ({type}) => ({
    message: `Modifier cannot be loaded. Path has incorrect type`,
    details: `Modifier path must be string, ${type} given`,
  }),
  
  EMODIFIERTYPE: ({type}) => ({
    message: `Modifier cannot be loaded. Modifier has incorrect type`,
    details: `Modifier must be a function or object, ${type} given`,
  }),
};
